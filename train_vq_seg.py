...
from models.vq_seg.vq_trainer import RVQTokenizerTrainer
...
if __name__ == "__main__":
    ...
    body_pc_vq = sum(param.numel() for param in body_net.parameters())
    # print("Total parameters of discriminator net: {}".format(pc_vq))
    # all_params += pc_vq_dis

    trainer = RVQTokenizerTrainer(opt, left_arm_vq_model=left_arm_net, right_arm_vq_model=right_arm_net, body_vq_model=body_net)
