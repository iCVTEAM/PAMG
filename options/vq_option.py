...
def arg_parse(is_train=False):
    ...
    parser.add_argument("--left_arm_code_dim", type=int, default=128, help="embedding dimension")
    parser.add_argument("--right_arm_code_dim", type=int, default=128, help="embedding dimension")
    parser.add_argument("--up_body_code_dim", type=int, default=128, help="embedding dimension")
    parser.add_argument("--body_code_dim", type=int, default=512, help="embedding dimension")
    parser.add_argument("--down_body_code_dim", type=int, default=256, help="embedding dimension")
    parser.add_argument("--left_leg_code_dim", type=int, default=128, help="embedding dimension")
    parser.add_argument("--right_leg_code_dim", type=int, default=128, help="embedding dimension")
    parser.add_argument("--other_body_code_dim", type=int, default=256, help="embedding dimension")
    parser.add_argument("--nb_code", type=int, default=128, help="nb of embedding")
    ...
    parser.add_argument('--left_arm_dim', type=list, default=[], help='left_arm_dim')
    parser.add_argument('--right_arm_dim', type=list, default=[], help='right_arm_dim')
    parser.add_argument('--whole_body_dim', type=list, default=[], help='whole_body_dim')
