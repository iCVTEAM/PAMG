...
from models.mask_transformer_token.transformer import MaskTransformer
from models.mask_transformer_token.transformer_trainer import MaskTransformerTrainer
...
if __name__ == '__main__':
    ...
    trainer = MaskTransformerTrainer(opt, t2m_transformer, left_arm_net, right_arm_net, body_net)
