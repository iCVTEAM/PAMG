...
from models.mask_transformer_bge.transformer import ResidualTransformer
from models.mask_transformer_bge.transformer_trainer import ResidualTransformerTrainer
...
if __name__ == '__main__':
    parser = TrainT2MOptions(default_name="rtrans_bge_b64dp0.2wog")
    opt = parser.parse()
    fixseed(opt.seed)
    ...
    trainer = ResidualTransformerTrainer(opt, res_transformer, left_arm_net, right_arm_net, up_body_net, down_body_net)
