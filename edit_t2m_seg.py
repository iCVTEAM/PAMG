...
from gen_t2m import load_vq_model, load_res_model, load_trans_model, dim_sep
...
if __name__ == '__main__':
    ...
    vq_opt.left_arm_dim, vq_opt.right_arm_dim, vq_opt.whole_body_dim = dim_sep(vq_opt.dataset_name)
