...
from models.mask_transformer_bcft.transformer import MaskTransformer
from models.mask_transformer_bcft.transformer_trainer import MaskTransformerTrainer
...
def load_vq_model():
    ...
    fine_net.load_state_dict(ckpt['fine_net'])
    print(f'Loading VQ Model {opt.vq_name}')
    return left_arm_vq_model, right_arm_vq_model, up_body_vq_model, down_body_vq_model, fine_net, vq_opt
...
if __name__ == '__main__':
    ...
    left_arm_net, right_arm_net, up_body_net, down_body_net, fine_net, vq_opt = load_vq_model()
    ...
    trainer = MaskTransformerTrainer(opt, t2m_transformer, left_arm_net, right_arm_net, up_body_net, down_body_net, fine_net)
