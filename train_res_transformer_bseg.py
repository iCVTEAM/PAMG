...
from models.mask_transformer_bseg.transformer import ResidualTransformer
from models.mask_transformer_bseg.transformer_trainer import ResidualTransformerTrainer
...
if __name__ == '__main__':
    ...
    left_arm_net, right_arm_net, body_net, vq_opt = load_vq_model()
    ...
    trainer = ResidualTransformerTrainer(opt, res_transformer, left_arm_net, right_arm_net, body_net)
