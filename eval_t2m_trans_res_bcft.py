...
from models.mask_transformer_bcft.transformer import MaskTransformer, ResidualTransformer
...
def load_vq_model(vq_opt, which_epoch):
    ...
    return left_arm_vq_model, right_arm_vq_model, up_body_vq_model, down_body_vq_model, fine_net, vq_epoch
...
if __name__ == '__main__':
    ...
    left_arm_net, right_arm_net, up_body_net, down_body_net, fine_net, vq_epoch = load_vq_model(vq_opt, 'net_best_fid.tar')
        ...
        for i in range(repeat_time):
            with torch.no_grad():
                best_fid, best_div, Rprecision, best_matching, best_mm = \
                    eval_t2m.evaluation_mask_transformer_test_plus_res_seg(model_opt, eval_val_loader, left_arm_net, up_body_net, down_body_net, right_arm_net, fine_net, res_model, t2m_transformer,
