...
from gen_t2m_con_ab import load_vq_model, load_trans_model, dim_sep
...
if __name__ == '__main__':
    ...
    # 遍历 opt.edit_limb 列表
    if len(opt.edit_limb) == 1 and opt.edit_limb[0].startswith("'") and opt.edit_limb[0].endswith("'"):
        opt.edit_limb[0] = opt.edit_limb[0].strip("'")
