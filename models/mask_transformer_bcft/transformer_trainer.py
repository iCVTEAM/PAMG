...
class MaskTransformerTrainer:
    def __init__(self, args, t2m_transformer, left_arm_vq_model, right_arm_vq_model, up_body_vq_model, down_body_vq_model, fine_net):
        self.opt = args
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_mask_transformer_seg(
            self.opt, self.opt.save_root, eval_val_loader, self.t2m_transformer, self.left_arm_vq_model,
            self.right_arm_vq_model, self.up_body_vq_model, self.down_body_vq_model, self.fine_net, self.logger, epoch, best_fid=100, best_div=100,
        ...
        while epoch < self.opt.max_epoch:
            ...
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_mask_transformer_seg(
                self.opt, self.opt.save_root, eval_val_loader, self.t2m_transformer, self.left_arm_vq_model,
                self.right_arm_vq_model, self.up_body_vq_model, self.down_body_vq_model, self.fine_net, self.logger, epoch,
...
class ResidualTransformerTrainer:
    def __init__(self, args, res_transformer, left_arm_vq_model, right_arm_vq_model, up_body_vq_model, down_body_vq_model, fine_net):
        self.opt = args
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_res_transformer_seg(
        ...
        while epoch < self.opt.max_epoch:
            ...
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_res_transformer_seg(
                self.opt, self.opt.save_root, eval_val_loader, self.res_transformer, self.left_arm_vq_model,
                self.right_arm_vq_model, self.up_body_vq_model, self.down_body_vq_model, self.fine_net, self.logger, epoch, best_fid=best_fid,
