...
from utils.eval_t2m import evaluation_mask_transformer_com, evaluation_res_transformer_com
...
class MaskTransformerTrainer:
    def __init__(self, args, t2m_transformer, body_vq_model):
        self.opt = args
    ...
    def forward(self, batch_data):
        ...
        # (b, n, q)
        code_idx, _ = self.body_vq_model.encode(motion)
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_mask_transformer_com(
            self.opt, self.opt.save_root, eval_val_loader, self.t2m_transformer, self.body_vq_model,
            self.logger, epoch, best_fid=100, best_div=100,
...
class ResidualTransformerTrainer:
    def __init__(self, args, res_transformer, body_vq_model):
        self.opt = args
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer = evaluation_res_transformer_com(
            self.opt, self.opt.save_root, eval_val_loader, self.res_transformer, self.body_vq_model,
            self.logger, epoch,
