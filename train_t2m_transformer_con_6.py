...
from models.mask_transformer_con_6.transformer import MaskTransformer
from models.mask_transformer_con_6.transformer_trainer import MaskTransformerTrainer
...
if __name__ == '__main__':
    ...
    left_arm_net, right_arm_net, up_body_net, left_leg_net, right_leg_net, other_body_net, vq_opt = load_vq_model()
    ...
    if opt.fix_token_emb:
        t2m_transformer.load_and_freeze_token_emb(left_arm_net.quantizer.codebooks[0], right_arm_net.quantizer.codebooks[0],
                                                right_arm_net.quantizer.codebooks[0], left_leg_net.quantizer.codebooks[0], 
                                                right_leg_net.quantizer.codebooks[0], other_body_net.quantizer.codebooks[0])
    ...
    trainer = MaskTransformerTrainer(opt, t2m_transformer, left_arm_net, right_arm_net, up_body_net, left_leg_net, right_leg_net, other_body_net)
