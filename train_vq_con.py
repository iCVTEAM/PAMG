...
from models.vq_seg_con.vq_trainer import RVQTokenizerTrainer
...
if __name__ == "__main__":
    ...
    trainer = RVQTokenizerTrainer(opt, left_arm_vq_model=left_arm_net, right_arm_vq_model=right_arm_net, up_body_vq_model=up_body_net, down_body_vq_model=down_body_net)
